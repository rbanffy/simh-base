...
clean: ## Cleans the build directory
	...
	@docker image ls | grep simh-base | cut -c 47-58 | xargs docker image rm --force
	@docker image ls | grep testing-slim | cut -c 47-58 | xargs docker image rm --force
...
build_amd64: build_dir simh-master ## Builds the Docker image for amd64
...
build_arm64: build_dir simh-master ## Builds the Docker image for arm64
...
build_armv6: build_dir simh-master ## Builds the Docker image for armv6
...
build_armv7: build_dir simh-master ## Builds the Docker image for armv7
...
build_ppc64le: build_dir simh-master ## Builds the Docker image for ppc64le
...
build_s390x: build_dir simh-master ## Builds the Docker image for s390x
